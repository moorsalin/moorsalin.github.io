...
My name is Moorsalin Munshi. I am interested in computer security, databases, geopolitics, and stock trading. I have a wide array of interests in addition to the listed items. I hope to get around to writing about my interests in an effort to consolidate my identity.

## What do I do

I am currently employed as a Senior HEDIS/QARR analyst at EmblemHealth. In practice, that translates to data analyst. I work with health insurance data from multiple vendors. A lot of my work involves reshaping data, analyzing it, and then telling stories with it.

I am also in grad school at Georgia Tech. This is the program I am participating in [here](http://www.omscs.gatech.edu/current-courses)
...
* [CS 6310 Software Architecture and Design](http://omscs.gatech.edu/cs-6310-software-architecture-design)
